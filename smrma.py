...
class Camera(BaseCamera):
    ...
    def frames():
        ...
        'inference/output', 'weights/yolov5s.pt','deep_sort_pytorch/deep_sort/deep/checkpoint/ckpt.t7', 'store_true', 'store_true', \
                'store_true', 600, 'store_true'
        source ='0'
        ...
        # initialize deepsort
        cfg = get_config()
        cfg.merge_from_file(deep_sort_weights.config_deepsort)
        ...
        for frame_idx, (path, img, im0s, vid_cap) in enumerate(dataset):
            ...
            pred = model(img, augment=output.augment)[0]
